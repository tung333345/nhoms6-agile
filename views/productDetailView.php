                            ...
                            <div class="box-warranty-info">
                                ...
                                <div class="box-content">
                                    <div class="items-info">
                                        ...
                                        <div class="description"><strong>Thời gian bảo hành:</strong> 1 ngày<br> 
                                        <strong>Chính sách bảo hành:</strong> Đổi mới sản phẩm tương đương hoặc hoàn tiền nếu không có sản phẩm thay thế.<br>
                                        <strong>Miễn trừ trách nhiệm: </strong> Từ chối bảo hành nếu khách hàng cố thay đổi mật khẩu và thông tin tài khoản cũng như vi phạm các điều khoản của sản phẩm.
                                    </div>
                                    </div>
                                    <!-- <div class="items-info">
                                        <div class="icon">
            ...
            <div class="box-detail-product-right">
                ...
                <div class="technical-info">
                    <div class="content-top">
                        <h2 class="title-m-b-3">Chi tiết sản phẩm</h2>
                    </div>
                    <ul class="technical-content">
                        <!-- <li class="technical-content-item">
                            <p>Quy trình nhận hàng</p>
                            <div><?= htmlspecialchars($product['Detail']) ?></div>
                        </li> -->
                        <li class="technical-content-item">
                            <p>Chi tiết</p>
                ...
                <!-- <p>
<br><strong style="font-size: 16px;">Quy trình nhận hàng</strong><br>
1. Đây là tài khoản tạo sẵn và được chia làm nhiều User, mỗi khách hàng sẽ được cấp 1 User riêng trong tài khoản để sử dụng.<br>
2. Sau khi mua hàng, bạn sẽ nhận được ngay thông tin tài khoản đăng nhập vào Netflix (bao gồm Email, Mật khẩu, Số User và pass User).<br>
3. Thời gian xử lý: Ngay sau khi thanh toán đơn hàng thành công.<br>
4. Hình thức nhận hàng: Thông tin đăng nhập trong đơn hàng.<br>
5. Sản phẩm có thể đăng nhập trên nhiều thiết bị nhưng chỉ được sử dụng 1 thiết bị tại 1 thời điểm (Không xem phim trên nhiều thiết bị cùng lúc). Lưu ý tài khoản không hỗ trợ sử dụng trên máy chiếu.<br>
6. Sản phẩm sẽ chỉ hỗ trợ xem tại Việt Nam và một số quốc gia Đông Nam Á.
                    </p> -->
                    </div>
            </div>
        </div>
            ...
            <div class="products_byParentCategory">
                ...
                <div class="product">
                    <div class="product__info"><a href="?act=showProductDetail&id=<?= $relatedProduct['id'] ?> "
                            ...
                            <div class="product__image"><img style="max-width: 160px; max-height: 160px;"
                    ...
                    <div role="tablist" class="accordion">
                        <div class="mb-1">
                            <div class="b-button button__show-faq">
                                <p>Tại sao nên mua
                                    <?php echo htmlspecialchars($product['Name_product']); ?> tại Divine Shop?
                                </p>
                                <div></div>
                            </div>
