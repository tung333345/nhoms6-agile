                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="full-width">
                                                ...
                                                <select name="parent_cate" id="">
                                                    ...
                                                    <option value="5">Học tập</option>
                                                    <option value="6">Game Steam</option>
                                                    <option value="7">Edit Ảnh - Video</option>
                                                    <option value="8">Window</option>
                                                    <option value="9">Google Drive</option>
                                                    <option value="10">Steam Wallet</option>
                                                    <option value="11">Diệt Viruss</option>
                                                </select>
                                            </div>
                                            <br>
                                            <!-- <div>
